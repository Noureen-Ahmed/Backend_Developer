...
ASSIGN 5
comment edit
                    ASSIGNMENT FROM 9 TO 15
ASSIGN 1
int age , period ;
cout << "enter your age and your period"<<"\n";
cin >> age>>period;
cout << "My Age Is: " << age << "\n";
...
__name      [ valid ] => underscore
name@name   [ invalid ] => @ special character
name10name  [ valid] => number between
name!name   [ invalid ] => ! special character
first_NAME  [ valid ] => underscore
first_name  [ valid] => underscore
firstName   [ valid ] => no space
first name  [ invalid ] => space between
fn          [ invalid ] => reserved word
public      [ invalid] => reserved word
Public      [ valid ] =>  not reserved word
ASSIGN 4
string my_text = "============\n== Elzero ==\n============";
cout << my_text;
ASSIGN 5
...
cout << num << " | " << ++num << " | " << num << "\n"; // 11 | 12 | 12
cout << --num << " | " << --num << " | " << --num << "\n"; // 11 | 10 | 9
WE FINISHED IT ON 20/6/2023 AT 12:35 AM  THE DATA TYPES
...
WE FINSHED IT AT 11:26 PM THE IF + SWITCH CONDITION
